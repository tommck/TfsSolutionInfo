...
namespace TfsProjectInfo_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new TfsProjectInfoPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(McKearney.TfsSolutionInfo.GuidList.guidTfsProjectInfoCmdSet, (int)McKearney.TfsSolutionInfo.PkgCmdIDList.cmdidTfsProjectInfoSettings);
